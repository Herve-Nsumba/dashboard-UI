...
function Activities() {
  ...
  return (
    <div className="bg-[white] border  border-gray-200 px-3 rounded-md mt-5  md:w-[45%]">
      <br />
      ...
      <div className="mt-4">
        {inventoryLogs.map((log, index) => {
          ...
          return (
            <div
              key={index}
              className="border-b border-gray-200 py-4 flex items-center gap-4"
            >
