...
function Users() {
  ...
  return (
    <div>
      <div className="bg-[white] flex justify-between items-center px-5 py-5 rounded-lg">
        <h1 className="font-bold text-lg">Users</h1>
        <button className="bg-primaryColor-600 text-sm text-white rounded-lg py-2 px-4">
          Add User{" "}
        </button>
      </div>
            ...
            {users.map((user, index) => (
              ...
              >
                ...
                <td className="p-3 flex  gap-2">
                  <button className="text-primaryColor-600 font-medium text-sm">
                    Edit
                  </button>
